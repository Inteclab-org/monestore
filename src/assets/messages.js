const messages = {
  ...
  uz: {
    ...
    orderFirstStep: "Quyidagi link orqali o'zingizga yoqgan mahsulotni rasmini (skrinshot) yoki linkini oling va botga yuboring. \n\n 👉https://telegra.ph/Aksessuarlar-03-07",
  ...
  ru: {
    ...
    waitVerificationMsg: "RU To'lov tasdiqlanishini kuting...",
    ...
    finishManualAmountMsg: (id) => `RU Avval ${id}-mahsulotning miqdorini kiriting yoki tanlang!`,
    finishManualSizeMsg: (id) => `RU Avval ${id}-mahsulotning o'lchamini kiriting yoki tanlang!`,
    ...
    orderingMsg: "RU Siz buyurtma berish jarayonidasiz!",
    notOrderingMsg: "RU Buyurtma berish jarayoni to'xtatilgan! Yangi buyurtma berish uchun menyudan Buyurtma berish bo'limini tanlang.",
    orderSavedMsg: "RU Buyurtma muvaffaqiyatli saqlandi✅. To'lovni tasdiqlovchi rasmni jo'nating.",
    verifyStoppedMsg: "RU Buyurtma tasdiqlanmadi❌.",
    noItemsMsg: "RU Mahsulot qo'shilmagan!",
    nameChagedMsg: (name) => `RU Ismingiz <b>${name}</b>ga o'zgartirildi✅`,
    phoneChagedMsg: (phone) => `RU Raqam <b>${phone}</b> ga o'zgartirildi✅`,
    langChagedMsg: (lang) => `RU Hozirgi til: <b>${lang}</b>✅`,
    chooseSectionMsg: `RU Kerakli bo'limni tanlang:`,
    notDeliveredMsg: `RU Oxirgi buyurtmangiz hali yakunlanmagan!`,
    notPaidMsg: `RU Oxirgi buyurtmaga hali to'lov qilinmagan!`,
