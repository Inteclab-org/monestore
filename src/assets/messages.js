const messages = {
  ...
  uz: {
    ...
    selectPageMsg: "Sahifani tanlang:",
    ...
    noPaymentImageMsg: `Chek rasmi topilmadi!`,
  ...
  ru: {
    ...
    selectPageMsg: "Выберите страницу:",
    ...
    noPaymentImageMsg: `Изображение оплаты не найдено!`,
    ...
    imageRequiredMsg: "Отправьте изображения чекa (скриншот), подтверждающего оплату!",
